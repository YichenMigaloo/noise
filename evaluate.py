...
def eval_adapter_network(args, dataset_path, dataset_names, image_extensions, device):
    ...
    if '100k' in args.model:
        ...
        model_names = ['/content/noise/train_outputs/adapter_60k/']
    elif '40k' in args.model:
...
def eval_prompt_tuning(args, dataset_path, dataset_names, image_extensions, device):
    ...
    if '20k' in args.model:
        ...
        model_names = ['/content/noise/train_outputs/coop_40k_2epochs/']
    elif '60k' in args.model:
        model_names = ['/content/noise/train_outputs/coop_60k_2epochs/']
    elif '80k' in args.model:
...
def main(args):
    ...
    dataset_names = ['cyclegan','dalle2','dalle3','deepfake','eg3d','faceswap','firefly','gaugan',
                     'glide_50_27','glide_100_10','glide_100_27','guided','ldm_100','ldm_200','ldm_200_cfg',
                     'midjourney_v5','progan','sd_512x512','sdxl','stargan','stylegan','stylegan2','stylegan3','taming']
    
    
    dataset_names = ['sdxl','dalle2','guided','taming']
