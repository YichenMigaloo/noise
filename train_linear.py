...
class modifiedmodel(torch.nn.Module):
    def __init__(self):
        ...
        print("Original Transformer Blocks:", len(self.feature_extractor.visual.transformer.resblocks))
        self.feature_extractor.visual.transformer.resblocks = torch.nn.Sequential(*list(self.feature_extractor.visual.transformer.resblocks[:-1]))
        print("Modified Transformer Blocks:", len(self.feature_extractor.visual.transformer.resblocks))
